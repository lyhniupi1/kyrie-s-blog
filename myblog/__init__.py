...
from myblog.models import Admin, Comment, Category, Post, Link, Skill
...
from myblog.extensions import bootstrap, db, login_manager, csrf, ckeditor, mail, moment, migrate, assets_env, css, js, whooshee
...
def register_template_context(app):
    ...
    def make_template_context():
        ...
        return(dict(admin=admin, categories=categories, links=links, unread_comments=unread_comments, skills=skills))
